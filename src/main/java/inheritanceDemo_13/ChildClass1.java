...
public class ChildClass1 extends BaseClass  //Use extends keyword for Class inheritance
{

	public static void main(String[] args)
	{
	   BaseClass obj1=new BaseClass(); // Scenario 2 - Parent Reference & Parent Object
